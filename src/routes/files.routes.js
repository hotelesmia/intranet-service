...
import { getZones, postZone, getDirectories, postDirectory, uploadFile, getDirectoryFiles, getFile, getZoneDirectories, downloadFile } from "../controllers/files.controller.js";
const router = Router()
...
router.get('/files/download/:file', verifyToken, downloadFile)
